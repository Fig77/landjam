...
const EmailForm = () => {
 ...
 return (
   <form className='class="mt-8 space-y-6"' action="" method="POST" target='#'>
     ...
     <div className='pt-4'>
       <button  onclick = { () => { sendForm() } } type="submit" class="group relative w-full flex justify-center py-1 px-2  border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" disabled ={disabled}>
