...
return (
   <form className='class="mt-8 space-y-6"' action="https://jamform.com/f/{formId}" method="POST">
     ...
     <div className='pt-4 flex justify-center items-center'>
       <button type="submit" class="group relative flex justify-center py-3 px-5 border border-transparent text-sm font-medium rounded-full text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
