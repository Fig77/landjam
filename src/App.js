    ...
    <img alt="logo header" src={logo} className="logo-nav"/>
      ...
      <div className='flex flex-col justifiy-between items-center self-center text-center'>
        ...
        <div className="main-subtext">
          <h2 className="px-2 h2text text-center nont font-sans text-white tracking-wider phones-pt:text-lg mb-2 phones: desktop: text-lg">TE INVITAMOS A DISFRUTAR UNA OPCIÓN MÁS SENCILLA PARA ELEGIR EL MOMENTO Y LUGAR DÓNDE SALIR CON AMIGOS</h2>
        </div>
        <h3 className="text-white text-sm font-light tracking-ultra phones-pt:mb-3 phones:mb-4 desktop: text-base mb-4">
       <br/> Si sos propetario de un local, <br/> contactanos para conocer nuestros servicios.
        </h3>
        <EmailForm />
