    ...
    <img alt="logo header" src={logo} className="logo-nav"/>
      ...
      <div className='flex flex-col justifiy-between items-center self-center text-center'>
        ...
        <div className="main-subtext">
          <h2 className="px-2 text-center nont font-sans text-white tracking-wider phones-pt:text-lg mb-2 phones: desktop: text-lg">TE INVITAMOS A DISFRUTAR DE UNA MANERA MÁS SENCILLA DE ELEGIR EL MOMENTO Y EL LUGAR EN DONDE QUIERAS IR DE LA MANERA QUE SOLO NOSOTROS PODEMOS BRINDARTE</h2>
        </div>
